...
import CursorMovingAnimationSingleCard from "../../utils/HomeCursorMovingAnimation/cursorMovingAnimationSingleCard";


const CursorMovingAnimation = () => {
   ...
   const [mp, setMp] = useState({ x: 0, y: 0 })
    ...
    return (
        <div className=" relative z-10 h-96 md:block hidden bg-gradient-to-r from-[#47d1d8] to-[#e2feff]">

            <div onMouseLeave={handleMouseLeave} ref={container} className='overflow-hidden md:block hidden relative h-96 mt-10 w-full '>
                <motion.div className='' ref={canvasRef}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4">
                        <div className="col-span-1 ">
                            {quotes.slice(0, 6)?.map((single) => (
                                <CursorMovingAnimationSingleCard mp={mp} {...single} key={single.id} />
                            ))}
                        </div>
                        <div className="col-span-1">
                ...
                <div className="flex justify-center backdrop-blur-sm bg-white/30 items-center absolute pointer-events-none inset-0">
                    <div className='text-center w-1/2'>
                        ...
                        <p className="text-lg mt-5  leading-relaxed text-gray-800">
                        codeXriddle is a dynamic web development company renowned for crafting cutting-edge websites. They specialize in SEO-friendly designs, ensuring online success for businesses through innovative digital solutions. 
                        </p>
                    </div>
                </div>
            </div>
...
export default CursorMovingAnimation;