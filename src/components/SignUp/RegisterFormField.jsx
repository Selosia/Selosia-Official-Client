    ...
    if (imgURL) {
      createUser(email, password)
        .then(() => {
          ...
          setProcess(true);
          postAUserInSignUp(userData).then((response) => {
            ...
            <div>
              ...
              <div className="border border-gray-500 rounded-xl flex items-center">
                ...
                <input
                  ...
                  required
                />
                <div onClick={handleShow2} className="mr-4">
                  {!show2 ? (
                    <FaRegEye className="text-xl"></FaRegEye>
                  ) : (
                    <FaRegEyeSlash className="text-xl"></FaRegEyeSlash>
            ...
            <div>
              ...
              <div className="">
                <div className="mt-6">
                  <button
                    type="submit"
                    className="w-full text-xl px-3 py-2 text-white rounded-md title bg-[#26BFC7]"
                  >
                    {isInProcess ? (
                      <div className="flex gap-2">
                        <h1 className="mt-1">Processing</h1>
                ...
                <Link
                  ...
                  className="hover:underline text-[#3d49ef] hover:text-[#0011ff] mt-6"
                >
                  ...
                  <>
                    {imgURL ? (
                      ...
                      >
                        <img
                          src={imagePreview}
                          className="object-cover h-64 w-96 mt-3 bg-teal-50 rounded"
                          alt="Preview"
                        />
