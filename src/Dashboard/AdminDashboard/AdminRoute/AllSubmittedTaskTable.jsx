...
const AllSubmittedTaskTable = () => {
  ...
  return (
    <>
      <AllSubmittedTaskHeading Heading ={"Total Submited Task"} numberHeading={"Total Number"} task={datas.length}></AllSubmittedTaskHeading>
...
export default AllSubmittedTaskTable;
