...
const OrderNowInputField = ({ handleSubmit, setConvertedDatetime }) => {
    ...
    const handleInputChange = (event) => {
        ...
        const formattedDate = `${selectedDate.getDate().toString().padStart(2, '0')}-${months[selectedDate.getMonth()]}-${selectedDate.getFullYear()}`;
