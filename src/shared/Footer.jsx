...
const Footer = () => {
  return (
    <section className="py-10 bg-gray-900 sm:pt-16 lg:mt-52">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12">
          <div className="bg-[#dbf7f8] text-gray-900 p-6 -mt-32 md:col-span-4 rounded-md">
            <div className="py-5">
              <FooterLogoStyle />
            </div>
            ...
            <div className="py-5">
              ...
              <div className="flex gap-7">
                <a
                  href="https://www.facebook.com/profile.php?id=100095077134426"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://www.instagram.com/webtechsolution/"
                  target="_blank"
                  rel="noreferrer"
                  className="cursor-pointer"
                >
                ...
                <a
                  ...
                  className="cursor-pointer"
                >
                  <AiTwotoneMail className="text-3xl -mt-1" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between">
          <h2 className="text-xl font-semibold text-[#26BEC7]">SELOSIA</h2>
          ...
          <ul className="flex items-center space-x-3 md:order-3">
            <li>
              <a
                href="#"
                title=""
                className="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-[#27E8B3] hover:bg-[#27E8B3] hover:border-[#27E8B3] focus:border-[#27E8B3]"
              >
                <svg
                  className="w-4 h-4"
          ...
          <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">
            © Copyright 2023, All Rights Reserved by Selosia Ltd.
          </p>
        </div>
      </div>
    </section>
