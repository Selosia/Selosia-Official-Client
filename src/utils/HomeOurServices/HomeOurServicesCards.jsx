...
const HomeOurServicesCards = () => {
  return (
    <div className="grid gap-4 font-semibold lg:font-normal row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
      <div className="flex flex-col justify-evenly p-5 border rounded shadow-md hover:scale-95 duration-500 hover:shadow-xl bg-[#F2F2F2]">
        <div>
      ...
      <div className="flex flex-col justify-evenly p-5 border rounded shadow-md hover:scale-95 duration-500 hover:shadow-xl bg-[#F2F2F2]">
        <div>
          <div className="flex items-center justify-center w-20 h-20 -mt-3 mb-4 rounded-full shadow-[inset_-12px_-8px_40px_#46464620] text-[#26BEC7]">
      ...
      <div className="flex flex-col justify-evenly p-5 border rounded shadow-md hover:scale-95 duration-500 hover:shadow-xl bg-[#F2F2F2]">
        <div>
          ...
          <h6 className="mb-2 text-xl font-bold">Domain & Hosting</h6>
          <p className="mb-3  text-gray-900">
      ...
      <div className="flex flex-col justify-evenly p-5 border rounded shadow-md hover:scale-95 duration-500 hover:shadow-xl bg-[#F2F2F2]">
        <div>
          ...
          <h6 className="mb-2 text-xl font-bold">24/7 support</h6>
          <p className="mb-3  text-gray-900">
